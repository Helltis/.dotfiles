...
keys = [
    ...
    Key(["mod1"], "f", lazy.spawn('brave')),
    Key(["mod1"], "m", lazy.spawn('pcmanfm')),
    Key(["mod1"], "q", lazy.to_screen(1)),
    Key(["mod1"], "w", lazy.to_screen(0)),
...
layouts = [
    layout.MonadTall(margin=6, border_width=2,
                     border_focus="#014421", border_normal="#f4c2c2"),
